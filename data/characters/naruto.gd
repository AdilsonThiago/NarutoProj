...
func SpecialSpritesHide():
	...
	#interrompida
	get_node("player/teleport").hide()
	get_node("player/teleport").position = Vector2(0,0)
	get_node("player/fight4").hide()
	get_node("player/fight5").hide()
	pass
